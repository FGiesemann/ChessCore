...
TEST_CASE("Position.Bitboard.Init.FEN", "[Position][Init][FEN]") {
    ...
    Position position2{FenString{"r1bq1knr/p1pp1ppp/1pnb4/4p1B1/2BPP2P/2NQ2P1/PPP2P2/R3K1NR b KQ h3 0 1"}};
...
TEST_CASE("Position.Bitboard.Check State.Stalemate", "[Position]") {
    ...
    CHECK(Position{FenString{"8/8/8/8/8/5k1q/8/6K1 w - - 0 1"}}.check_state() == CheckState::Stalemate);
    CHECK(Position{FenString{"7k/8/6Q1/8/2K5/8/8/8 b - - 0 1"}}.check_state() == CheckState::Stalemate);
}
